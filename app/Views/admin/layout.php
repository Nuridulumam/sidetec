    ...
    <aside class="fixed inset-y-0 left-0 z-40 flex w-64 flex-col border-r border-slate-800 bg-slate-900 text-slate-100 lg:static">
        ...
        <nav class="flex flex-1 flex-col gap-1 overflow-y-auto px-3 py-5">
            ...
            $navMain = [
                ...
                ['key' => 'rules', 'label' => 'Rule Klasifikasi', 'href' => site_url('admin/rule-klasifikasi'), 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2'],
                ['key' => 'laporan', 'label' => 'Laporan', 'href' => site_url('admin/laporan'), 'icon' => 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
            ];
